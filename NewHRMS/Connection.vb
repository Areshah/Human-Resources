...
Module connection
    ...
    Public Sub createConnection()
        ...
        '  con.ConnectionString = "Data Source=.\DESKTOP-TFUPO14;Initial Catalog=HRMS;Integrated Security=true;"
        con.ConnectionString = "Server=(local);DataBase=HRMS;Integrated Security=SSPI"
        con.Open()
